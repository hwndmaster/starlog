...
internal sealed record LogReadingResult(SourceArtifacts? FileArtifacts, ImmutableArray<LogRecord> Records, ICollection<LoggerRecord> Loggers, ICollection<LogLevelRecord> LogLevels, ICollection<string> Errors)
{
